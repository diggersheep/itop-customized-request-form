...
class RequestTemplateFieldsHandler extends TemplateFieldsHandler
{
	...
	static public function GetPrerequisiteAttributes($sClass = null)
	{
		...
		$oSearch = DBSearch::FromOQL("SELECT TemplateField WHERE input_type IN ('drop_down_list', 'radio_buttons') AND values LIKE 'SELECT %:this->%'");
		$oSet = new DBObjectSet($oSearch);
		$oSet->OptimizeColumnLoad(array('TemplateField' => array('values')));
